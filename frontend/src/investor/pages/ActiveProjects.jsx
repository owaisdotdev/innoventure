        ...
        const fetchProposals = async () => {
            try {
                ...
                const response = await fetch(
                    `http://localhost:3000/proposals/investor/${startupId}`,
                    {
                        headers: {
                      ...
                      {proposals.map((proposal) => (
                        ...
                        >
                          ...
                          <p className="text-gray-400 text-sm mt-2">
                            ...
                            {proposal.startupId.businessPlan?.industry || "N/A"}
                          </p>
                          <p className="text-gray-400 text-sm">
                            <strong className="text-gray-200">Funding:</strong>{" "}
                            ${proposal.fundingRequired?.toLocaleString()}
                          </p>
                          <p className="text-indigo-400 mt-3">{proposal.title}</p>
                        </div>
                      ))}
                    </div>
                  )}
