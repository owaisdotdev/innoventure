    ...
    const handleAccept = async (proposal) => {
        try {
            ...
            const totalAmount = ethers.parseUnits(
                String(proposal?.fundingRequired || "0"),
                6
            );
            const deadline =
                Math.floor(Date.now() / 1000) + 2 * 365 * 24 * 60 * 60;

            const tx = await escrowContract.createInvestment(
                startup,
                totalAmount,
                deadline
            );
            ...
            <div className="p-6">
                ...
                <div className="text-sm text-gray-600 space-y-1">
                    ...
                    <p>
                        ...
                        {proposal.industry || "Not provided"}
                    </p>
                    <p>
                        <strong>Attachment:</strong> {proposal.attachment}
                    </p>
                    <p>
                        <strong>Message:</strong>{" "}
                        {proposal.message || "Not provided"}
                    </p>
                </div>
