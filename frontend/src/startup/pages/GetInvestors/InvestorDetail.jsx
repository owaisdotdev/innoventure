      ...
      <div className="min-h-screen flex items-center justify-center  py-12">
        <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-4xl">
          ...
          <div className="flex justify-between items-center">
            <span className={`px-3 py-1 text-sm font-semibold rounded-full ${investor?.profileStatus === "active"
              ? "bg-green-100 text-green-600"
              : "bg-red-100 text-red-600"
              }`}>
              Profile: {investor?.profileStatus || "Status Unknown"}
            </span>
            <button onClick={handlePitch} className="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2 rounded-lg shadow-md"
            > Pitch Now </button>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-h-[90%] overflow-auto max-w-lg">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input id="startupName" name="startupName" value={formData.startupName} onChange={handleChange} type="text"
              ...
              <div className="mb-4">
                ...
                <input id="founderName" name="founderName" value={formData.founderName}
                  onChange={handleChange} type="text" className="w-full px-4 py-2 border rounded-lg" required
                />
              </div>
              <div className="mb-4">
